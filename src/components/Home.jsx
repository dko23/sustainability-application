  ...
  return (
      ...
      <h1 class="display-4">For A Greener Future</h1>
            ...
            <motion.div 
                          ...
                          viewport={{ once: true }}
            className="row energy-meter ">
              <div className="col-md-6">
            <h1 className="font-weight-bold">Energy-smart decisions for a sustainable lifestyle</h1>
            <h5 className='energy-management'>Embrace the power of data-driven energy management. By analyzing your energy patterns, Sustania tailors personalized energy-saving tips, empowering you to take control of your consumption like never before.</h5>
              </div>
            ...
            className="row energy-meter">
              ...
              <div className="col-md-6">
                ...
                <h5 className='energy-management'>Experience the joy of making conscious choices that leave a lasting imprint on the world. Together, we can reduce waste, conserve resources, and protect our natural habitats for generations to come. </h5>
              </div>
        </motion.div>
